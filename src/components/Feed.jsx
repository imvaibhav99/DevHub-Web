...
const Feed = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center px-2 bg-gradient-to-br from-gray-950 via-purple-950/80 to-[#120922]">
      ...
      {loading ? (
        <div className="flex flex-col items-center gap-2" aria-busy="true" role="status">
          <span className="loading loading-spinner loading-lg text-purple-500"></span>
          <span className="text-purple-200 text-lg animate-pulse">Fetching your dev matches...</span>
        </div>
      ) : error ? (
        ...
        <div className="animate-fade-in-up grid gap-4 w-full max-w-4xl px-4">
        ...
        <div className="flex flex-col items-center justify-center p-8 rounded-2xl bg-white/10 backdrop-blur-md shadow-lg mt-12">
          <svg className="w-16 h-16 text-purple-300 mb-4" viewBox="0 0 24 24" fill="none">
            <path
              fill="currentColor"
      ...
      <style>{`
        ...
        .animate-fade-in-up {
          animation: fade-in-up 0.66s cubic-bezier(.32,1.1,.36,1) both;
        }
      `}</style>
    </div>
  );
