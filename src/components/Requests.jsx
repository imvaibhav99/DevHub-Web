...
//                     src={user.photoUrl || 'https://raw.githubusercontent.com/vaibhavkachare/dark-avatar/main/dark-profile.png'}
//                     alt="profile"
//                   />
//                   <div>
//                     <h2 className="card-title text-lg font-semibold">{user.firstName} {user.lastName}</h2>
//                     <p className="text-sm text-gray-100 font-semibold">{user.age}</p>
//                     <p className="text-sm text-gray-100 font-semibold">{user.gender}</p>
//                     <p className="text-sm text-gray-100 font-semibold">{user.about || 'No bio available'}</p>
//                   </div>
//                 </div>
